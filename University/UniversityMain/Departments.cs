    ...
    public partial class Departments : Form
    {
        ...
        private void Departments_Load(object sender, EventArgs e)
        {
            foreach (var access in connectionDB.Accesses)
            {
                switch (access)
                {
                    case Logics.Functions.Connection.ConnectionDB.function_access.department_add: panel3.Visible = true; edit_data = true; break;
                    case Logics.Functions.Connection.ConnectionDB.function_access.getdepartmentfull:
        ...
        private void DepartmentInfo_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (senderGrid.Columns[e.ColumnIndex] is DataGridViewButtonColumn & senderGrid.Columns[e.ColumnIndex].Name == "DeleteDepartment" & e.RowIndex >= 0 & edit_data == true)
            {
